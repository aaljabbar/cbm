...
<div class="page-content">
    <div class="row">
        <div class="col-sm-12" id="contentJgGrid">
            <!-- PAGE CONTENT BEGINS -->
    ...
    $(document).ready(function () {
        ...
        $(window).on('resize.jqGrid', function () {
         ...
         jQuery("#grid-table").jqGrid({
                 url:'<?php echo site_url('admin/gridRole');?>',
                 datatype: "json",
                 mtype: "POST",
                 //colNames:['Inv No','Date', 'Client', 'Amount','Tax','Total','Notes'],
                 colModel: [
                     { label: 'ID', name: 'ROLE_ID', key: true, width:5, sorttype:'number', editable: true,hidden:true },
                     { label: 'Nama Role', name: 'ROLE_NAME', width:250, align:"left", editable:true,editrules : { required: true}},
                     { label: 'Desc', name: 'ROLE_DESC', width:350, align:"left", editable:true}
                 ],
                 width: '100%',
                 height: '100%',
                  scrollOffset:0,
                ...
                editurl: '<?php echo site_url('admin/crud_role');?>',
                caption:"Daftar Role"
