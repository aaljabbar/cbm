...
//-----------------------------------------------------
    ...
    public function gridLovGetContract()
    {
        ...
        $query = "SELECT * FROM TABLE(F_GET_CONTRACT_INFO(".$idd."))";
        ...
        if (!empty($searchPhrase)) {
            $req_param['where'][] = "(upper(CONTRACT_NO) LIKE upper('%" . $searchPhrase . "%'))";
        }
    ...
    public function gridLovAppRole()
    {
